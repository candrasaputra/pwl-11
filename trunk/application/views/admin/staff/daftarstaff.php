                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php echo "
                                    <td>
                                    <a class='btn btn-primary' href =editstaff_staff/$n->id_staff> <i class='fa fa-edit '></i> Edit</a>
                                    <a class='btn btn-danger' href =deletestaff_staff/$n->id_staff> <i class='fa fa-trash-o'></i> Delete</a>
                                    </td>
                                "?>
                            </tr>   
                            <?php $no++?>
