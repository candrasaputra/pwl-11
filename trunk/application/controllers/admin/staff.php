...
class Staff extends MY_Controller{
	...
	public function editstaff($id){
		$this->data['staff'] = $this->staff_m->select_by_id($id)->row();

		$this->data['page']  = 'admin/staff/edit_staff';
		$this->data['title'] = 'Daftar Staff';

		$this->load->view('admin/index', $this->data);
	}

	public function proses_edit_staff(){
		...
		if (!empty($_FILES["foto"]["tmp_name"]))
		{
		    ...
		    $data['img_staff'] = $this->input->post('fotosaatini');
		}
